...
const pool = new Pool({
  connectionString: process.env.DATABASE_URL || 'postgresql://postgres.spyvybfefmutbjhpqklv:sekharG@2002@aws-1-ap-south-1.pooler.supabase.com:6543/postgres?pgbouncer=true',
  ssl: {
